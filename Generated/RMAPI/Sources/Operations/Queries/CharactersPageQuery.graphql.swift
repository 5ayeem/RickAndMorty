...
public class CharactersPageQuery: GraphQLQuery {
  public static let operationName: String = "CharactersPage"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query CharactersPage($page: Int) { characters(page: $page) { __typename info { __typename count next } results { __typename id name status species image } } }"#
    ))
